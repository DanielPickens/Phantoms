...
# img_list initiates a load for all tileset images
...
# button_list initiates the assigning of a button to each tile
button_list = []
b_col = 0
b_row = 0
...
# #Sets the load and save buttons to the bottom of the screen
...
while running:
	...
	# highlight current tile in tileset
	pygame.draw.rect(win, RED, button_list[current_tile].rect, 3)


	# map scroller will map the tileset to the right of the screen
	...
	#Current level display on the screen
